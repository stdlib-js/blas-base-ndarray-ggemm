...
```javascript
import ggemm from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-ndarray-ggemm@deno/mod.js';
```
...
```javascript
import matrix from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-matrix-ctor@deno/mod.js';
